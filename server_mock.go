...
func (m *MockServer) Push(channelID string, payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Push", channelID, payload)
	ret0, _ := ret[0].(error)
	return ret0
}

// Push indicates an expected call of Push.
func (mr *MockServerMockRecorder) Push(channelID, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Push", reflect.TypeOf((*MockServer)(nil).Push), channelID, payload)
}
...
func (m *MockServer) SetAcceptor(acceptor Acceptor) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetAcceptor", acceptor)
}

// SetAcceptor indicates an expected call of SetAcceptor.
func (mr *MockServerMockRecorder) SetAcceptor(acceptor interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetAcceptor", reflect.TypeOf((*MockServer)(nil).SetAcceptor), acceptor)
}

// SetChannelMap mocks base method.
func (m *MockServer) SetChannelMap(channelMap ChannelMap) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetChannelMap", channelMap)
}

// SetChannelMap indicates an expected call of SetChannelMap.
func (mr *MockServerMockRecorder) SetChannelMap(channelMap interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetChannelMap", reflect.TypeOf((*MockServer)(nil).SetChannelMap), channelMap)
}

// SetMessageListener mocks base method.
func (m *MockServer) SetMessageListener(messageListener MessageListener) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetMessageListener", messageListener)
}

// SetMessageListener indicates an expected call of SetMessageListener.
func (mr *MockServerMockRecorder) SetMessageListener(messageListener interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetMessageListener", reflect.TypeOf((*MockServer)(nil).SetMessageListener), messageListener)
}

// SetReadwait mocks base method.
func (m *MockServer) SetReadwait(readwait time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetReadwait", readwait)
}

// SetReadwait indicates an expected call of SetReadwait.
func (mr *MockServerMockRecorder) SetReadwait(readwait interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetReadwait", reflect.TypeOf((*MockServer)(nil).SetReadwait), readwait)
}

// SetStateListener mocks base method.
func (m *MockServer) SetStateListener(stateListener StateListener) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetStateListener", stateListener)
}

// SetStateListener indicates an expected call of SetStateListener.
func (mr *MockServerMockRecorder) SetStateListener(stateListener interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetStateListener", reflect.TypeOf((*MockServer)(nil).SetStateListener), stateListener)
}
...
func (m *MockAcceptor) Accept(conn Conn, timeout time.Duration) (string, Meta, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Accept", conn, timeout)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(Meta)
	ret2, _ := ret[2].(error)
...
func (mr *MockAcceptorMockRecorder) Accept(conn, timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Accept", reflect.TypeOf((*MockAcceptor)(nil).Accept), conn, timeout)
}
...
func (m *MockMessageListener) Receive(agent Agent, payload []byte) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Receive", agent, payload)
}

// Receive indicates an expected call of Receive.
func (mr *MockMessageListenerMockRecorder) Receive(agent, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Receive", reflect.TypeOf((*MockMessageListener)(nil).Receive), agent, payload)
}
...
func (m *MockStateListener) Disconnect(channelID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Disconnect", channelID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Disconnect indicates an expected call of Disconnect.
func (mr *MockStateListenerMockRecorder) Disconnect(channelID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disconnect", reflect.TypeOf((*MockStateListener)(nil).Disconnect), channelID)
}
...
// Push mocks base method.
func (m *MockAgent) Push(payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Push", payload)
	ret0, _ := ret[0].(error)
	return ret0
}

// Push indicates an expected call of Push.
func (mr *MockAgentMockRecorder) Push(payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Push", reflect.TypeOf((*MockAgent)(nil).Push), payload)
}
...
func (m *MockConn) WriteFrame(opcode OpCode, payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteFrame", opcode, payload)
	ret0, _ := ret[0].(error)
	return ret0
}

// WriteFrame indicates an expected call of WriteFrame.
func (mr *MockConnMockRecorder) WriteFrame(opcode, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteFrame", reflect.TypeOf((*MockConn)(nil).WriteFrame), opcode, payload)
}
...
// Push mocks base method.
func (m *MockChannel) Push(payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Push", payload)
	ret0, _ := ret[0].(error)
	return ret0
...
// Push indicates an expected call of Push.
func (mr *MockChannelMockRecorder) Push(payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Push", reflect.TypeOf((*MockChannel)(nil).Push), payload)
}
...
// SetReadwait mocks base method.
func (m *MockChannel) SetReadwait(timeout time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetReadwait", timeout)
}

// SetReadwait indicates an expected call of SetReadwait.
func (mr *MockChannelMockRecorder) SetReadwait(timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetReadwait", reflect.TypeOf((*MockChannel)(nil).SetReadwait), timeout)
}
...
func (m *MockChannel) SetWritewait(timeout time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetWritewait", timeout)
}

// SetWritewait indicates an expected call of SetWritewait.
func (mr *MockChannelMockRecorder) SetWritewait(timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetWritewait", reflect.TypeOf((*MockChannel)(nil).SetWritewait), timeout)
}
...
// WriteFrame mocks base method.
func (m *MockChannel) WriteFrame(opcode OpCode, payload []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteFrame", opcode, payload)
	ret0, _ := ret[0].(error)
	return ret0
...
// WriteFrame indicates an expected call of WriteFrame.
func (mr *MockChannelMockRecorder) WriteFrame(opcode, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteFrame", reflect.TypeOf((*MockChannel)(nil).WriteFrame), opcode, payload)
}
...
func (m *MockClient) Connect(addr string) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Connect(addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Connect", reflect.TypeOf((*MockClient)(nil).Connect), addr)
}
...
func (m *MockClient) SetDialer(dialer Dialer) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetDialer", dialer)
}

// SetDialer indicates an expected call of SetDialer.
func (mr *MockClientMockRecorder) SetDialer(dialer interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetDialer", reflect.TypeOf((*MockClient)(nil).SetDialer), dialer)
}
...
func (m *MockDialer) DialAndHandshake(ctx DialerContext) (net.Conn, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DialAndHandshake", ctx)
...
func (mr *MockDialerMockRecorder) DialAndHandshake(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DialAndHandshake", reflect.TypeOf((*MockDialer)(nil).DialAndHandshake), ctx)
}
...
func (m *MockFrame) SetOpCode(opcode OpCode) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetOpCode", opcode)
}

// SetOpCode indicates an expected call of SetOpCode.
func (mr *MockFrameMockRecorder) SetOpCode(opcode interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetOpCode", reflect.TypeOf((*MockFrame)(nil).SetOpCode), opcode)
}

// SetPayload mocks base method.
func (m *MockFrame) SetPayload(payload []byte) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetPayload", payload)
}

// SetPayload indicates an expected call of SetPayload.
func (mr *MockFrameMockRecorder) SetPayload(payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetPayload", reflect.TypeOf((*MockFrame)(nil).SetPayload), payload)
}
